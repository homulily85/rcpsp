    ...
    def create_result_info(self, file_name: str, lb: int, ub: int, encoder) -> Dict[str, Any]:
        ...
        if isinstance(encoder, SATEncoder):
            return {
                ...
                'five_to_ten': encoder.sat_model.number_of_literal[NUMBER_OF_LITERAL.FIVE_TO_TEN.value],
                'more_than_ten': encoder.sat_model.number_of_literal[NUMBER_OF_LITERAL.MORE_THAN_TEN.value],
                'feasible': False,
                'make_span': 0,
...
def main():
    ...
    benchmark(args.dataset_name, encoder_type, timeout, args.verify, args.verbose, args.show_solution)
    print(
