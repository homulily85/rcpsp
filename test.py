from encoder.sat.incremental_sat.improved_rc_new_sc_based import ImprovedResourceConstraint
...
e = ImprovedResourceConstraint('data_set/j30.sm/j301_1.sm', 3, 100, enable_verify=True)
e.encode()
model = e.solve()
while model:
